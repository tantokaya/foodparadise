                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                {this.state.restaurant ? (
                                    <div className="row">
                                        <div className="col-6">
                                            <img src={this.state.restaurant.featured_image} alt="" style={{borderRadius: 5, width: 500}} className="img-responsive"></img>
                                        </div>
                                        <div className="col-6">
                                            <table className="table">
                                                <tbody>
                                                    <tr>
                                                        <td>Rating</td>
                                                        <td>{this.state.restaurant.user_rating.aggregate_rating}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cuisines</td>
                                                    ...
                                                    <tr>
                                                        <td>Cost for two</td>
                                                        <td>{this.state.restaurant.currency + ' ' + this.state.restaurant.average_cost_for_two}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
